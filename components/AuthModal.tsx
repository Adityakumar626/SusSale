      ...
      <DialogContent className="sm:max-w-150 p-6 rounded-2xl bg-background/95 backdrop-blur-md border border-border/60 shadow-2xl transition-all">
        <DialogHeader className="text-center space-y-2 sm:text-center">
          ...
          <DialogDescription className="text-muted-foreground text-sm">
            Sign in to your account to continue tracking your products.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-4 py-4 mt-2">
          ...
          >
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full gap-3 h-12 text-sm font-medium bg-card hover:bg-white/70 hover:text-accent-foreground border-border/80 shadow-sm transition-colors cursor-pointer rounded-xl"
            >
